...
if (isset($_SESSION["role_id"]) && $_SESSION["role_id"] == 2) {
    ...
    $purchacesQuery = "SELECT c.cart_id,u.username,ca.quantity,a.name,a.current_price,(a.current_price * ca.quantity) AS 'SUM',c.created_at FROM `carts` c, carts_articles ca,articles a,users u WHERE u.user_id = c.user_id AND c.cart_id = ca.cart_id AND a.article_id = ca.article_id ORDER BY c.cart_id DESC";

    $userCarts = "SELECT c.cart_id FROM `carts` c GROUP BY c.cart_id";
                                            ...
                                            <div class="card-header" id="headingOne">
                                                <h2 class="mb-0">
                                                    <button class="btn btn-link btn-block text-left" type="button"
                                                        ...
                                                        ORDER #
                                                        <?= $new_items[$index][0][0] ?> - <?= $new_items[$index][0][1] ?>
                                                    </button>
                                                </h2>
                                            </div>
