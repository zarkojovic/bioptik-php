...
if (isset($_SESSION["role_id"]) && $_SESSION["role_id"] == 2) {
    ...
    if (isset($_POST["submitEditTag"])) {
        ...
        if ($brGresaka > 0) {
            redirect("edit_question.php?id={$_POST["question_id"]}&errors={$errors}");
        } else {
            ...
            if ($rez) {
                redirect("edit_question.php?id=$qid&success=1");
            }
        }
    }
                        ...
                        <div class="col-12">
                            <div class="card card-primary">
                                ...
                                <form action="<?= $_SERVER["PHP_SELF"] ?>?id=<?= $_GET["id"] ?>" method="POST">
                                    ...
                                    <!-- /.card-body -->
                                    <input type="hidden" name="question_id" value="<?= $editQuestionId ?>">
