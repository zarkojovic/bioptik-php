            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Questions</h1>
                            <a href="insert_question.php" class="btn btn-primary mt-3">
                                New Question
                            </a>
                        </div>
                        <div class="col-sm-6">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($questions as $u):
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?= $u["type"] ? "Single Answer" : "Multiple Answer" ?>
                                                    </td>
                                                    <td>
                                                        <?= $u["status"] ? "Active" : "Inactive" ?>
                                                    </td>
                                                    <td>
                                                        <a href="edit_question.php?id=<?= $u["question_id"] ?>"
                                                            class="btn btn-primary">Edit</a>
                                                    </td>
                                                    <td>
                                                        <button class="btn btn-danger btnDelete" data-toggle="modal"
                                                            data-id="<?= $u["question_id"] ?>" data-target="#deleteModal">
                                                            Delete</button>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
    ...
    <script>
        $(document).ready(function () {
            $(".btnDelete").click(function () {
                ...
                deleteForm.question_id.value = id;
            });
        });
    </script>
</body>
